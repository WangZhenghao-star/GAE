...
def adj_cs(adj_matrix, data):   #Calculate the causal strength. Specifically, after generating the causal structure graph (which is represented as an adjacency matrix), input this adjacency matrix and then derive the causal strength based on it.
    """
...
def causal_strength(sam1, sam2, refMeasure=2):         # As for the specific calculation method, it involves subtracting two information entropies and then taking the reciprocal of the result.
    """
