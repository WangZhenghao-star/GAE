...
from data.simulator import CausalMatrixProcessor
...
class GAE(BaseLearner):
    ...
    def __init__(self,
                 ...
                 device_type='cpu',
                 device_ids='0',
                 lambda_penalty=0.01):  # Add the lambda_penalty parameter
        ...
        self.lambda_penalty = lambda_penalty  # Add the lambda_penalty attribute
    ...
    def learn(self, data, columns=None, **kwargs):
        ...
        causal_matrix = CausalMatrixProcessor().process_causal_matrix(causal_matrix, w_est, self.d)
    ...
    def _gae(self, x):
        ...
        trainer = ALTrainer(n=self.n,
                            ...
                            seed=self.seed,
                            device=self.device,
                            lambda_penalty=self.lambda_penalty)  # Pass the lambda_penalty parameter
