...
from data.evaluation import process_causal_matrix
...
class GAE(BaseLearner):
    ...
    def __init__(self,
                 ...
                 device_type='cpu',
                 device_ids='0',
                 lambda_penalty=0.01):  # 添加lambda_penalty参数
        ...
        self.lambda_penalty = lambda_penalty  # 添加lambda_penalty属性
    ...
    def learn(self, data, columns=None, **kwargs):
        ...
        causal_matrix = process_causal_matrix(causal_matrix, w_est, self.d)
    ...
    def _gae(self, x):
        ...
        trainer = ALTrainer(n=self.n,
                            ...
                            seed=self.seed,
                            device=self.device,
                            lambda_penalty=self.lambda_penalty)  # 传递lambda_penalty参数
